...
export function StatusBar() {
  ...
  return (
    <header className="flex h-11 shrink-0 items-center gap-2 border-b border-zinc-200 bg-white px-1.5 dark:border-zinc-800 dark:bg-zinc-950">
      <span className="text-sm font-semibold px-2 text-zinc-900 dark:text-zinc-100">
        Agent Explorer
      </span>
